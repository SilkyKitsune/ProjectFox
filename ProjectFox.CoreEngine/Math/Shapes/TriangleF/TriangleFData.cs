...
public partial struct TriangleF
{
    ...
    public static byte[][] GetBytesSeparate(TriangleF[] values, bool littleEndian) => default;
    ...
    /// <summary> Not Yet Implemented </summary>
    /// <returns> default </returns>
    public static bool TryParse(string str, out TriangleF value)
    {
        value = default;
        return default;
    }
    ...
    /// <summary> Not Yet Implemented </summary>
    /// <returns> default </returns>
    public static bool TryParseAny(string str, bool littleEndian, out TriangleF value)
    {
        value = default;
        return default;
    }
    ...
    /// <summary> Not Yet Implemented </summary>
    /// <returns> default </returns>
    public static bool TryParseBin(string str, bool littleEndian, out TriangleF value)
    {
        value = default;
        return default;
    }
    ...
    /// <summary> Not Yet Implemented </summary>
    /// <returns> default </returns>
    public static bool TryParseHex(string str, bool littleEndian, out TriangleF value)
    {
        value = default;
        return default;
    }
