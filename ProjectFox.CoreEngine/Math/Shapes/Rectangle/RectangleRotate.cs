...
public partial struct Rectangle
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Rectangle RotateByRightAngles(int rightAngles) => new(position.RotateByRightAngles(rightAngles), size);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Rectangle RotateByRightAngles(Vector refPoint, int rightAngles) => new(position.RotateByRightAngles(refPoint, rightAngles), size);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Rectangle RotateByRightAngles(VectorF refPoint, int rightAngles) => new(position.RotateByRightAngles(refPoint, rightAngles), size);
    #endregion
}