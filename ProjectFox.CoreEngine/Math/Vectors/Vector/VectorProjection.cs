...
{
    public static float[] OrthographicProjection(Vector[] values, Vector projectorPosition, int size, float rotation)
    {
    ...
    public static float[] OrthographicProjection(Vector[] values, VectorF projectorPosition, float size, float rotation)
    {
        if (values == null || values.Length == 0) throw new ArgumentNullException(nameof(values));
    ...
    public static float[] PerspectiveProjection(Vector[] values, Vector projectorPosition, float angle, float rotation)
    {
        if (values == null || values.Length == 0) throw new ArgumentNullException(nameof(values));
    ...
    public static float[] PerspectiveProjection(Vector[] values, VectorF projectorPosition, float angle, float rotation)
    {
        if (values == null || values.Length == 0) throw new ArgumentNullException(nameof(values));
    ...
    {
        rotation -= (int)rotation;
        Vector v = new(x - projectorPosition.x, y - projectorPosition.y);
